...
<br />
<div align="center">
  <img width="1919" height="850" alt="Screenshot 2025-10-11 152040" src="https://github.com/user-attachments/assets/15a547f5-3c25-481c-9e40-609a1f958d8f" />

<h3 align="center">NASA Space App - Solar System Explorer</h3>

  <p align="center">
    View details about the planets in the solar system
    <br />
    <a href="https://github.com/elfatairy/nasa/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    &middot;
    <a href="https://github.com/elfatairy/nasa/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/elfatairy/nasa.git
   cd nasa
   ```

2. Install dependencies (if using npm for Three.js)
   ```sh
   npm install
   ```
   
   Or simply include Three.js via CDN in your HTML:
   ```html
...
Project Link: [https://github.com/elfatairy/nasa](https://github.com/elfatairy/nasa)
...
[contributors-shield]: https://img.shields.io/github/contributors/elfatairy/nasa.svg?style=for-the-badge
[contributors-url]: https://github.com/elfatairy/nasa/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/elfatairy/nasa.svg?style=for-the-badge
[forks-url]: https://github.com/elfatairy/nasa/network/members
[stars-shield]: https://img.shields.io/github/stars/elfatairy/nasa.svg?style=for-the-badge
[stars-url]: https://github.com/elfatairy/nasa/stargazers
[issues-shield]: https://img.shields.io/github/issues/elfatairy/nasa.svg?style=for-the-badge
[issues-url]: https://github.com/elfatairy/nasa/issues
[license-shield]: https://img.shields.io/github/license/elfatairy/nasa.svg?style=for-the-badge
[license-url]: https://github.com/elfatairy/nasa/blob/main/LICENSE
